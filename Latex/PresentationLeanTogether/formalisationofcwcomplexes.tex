...
By us: 
  \begin{itemize}
    ...
    \item[\textcolor{Yellow}{\textbullet}] Compactly coherent spaces ($\sim 200$ LOC): in Mathlib/PRs
...
\begin{itemize}
  ...
  \pause
  \item[\textbullet] some of the theory of CW complexes is already in mathlib! 
\end{itemize}
\end{frame}
