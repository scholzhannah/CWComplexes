...
\begin{proof}
  ...
  We know that the compact coherentification is a compactly coherent space and that $A$ is closed if for every compact set $K \subseteq \kif (C \times E)$, $A \cap K$ is closed in $K$.
    ...
    Thus, there are finite sets $G \subseteq \{e_i^n \mid n \in \bN, i \in I_n \}$ and $H \subseteq \{f_j^m \mid m \in \bN, j \in J_m \}$ such that $\pr{1}{K} \subseteq D \cup \bigcup_{e \in G} e$ and $\pr{2}{K} \subseteq F \cup \bigcup_{f \in H} f$.
    Then,
    \begin{equation*}
      K \subseteq \pr{1}{K} \times \pr{2}{K} \subseteq \left( D \cup \bigcup_{e \in G} e \right) \times \left( F \cup \bigcup_{f \in H} f\right).
    \end{equation*}
    \begin{claim}
      It suffices to show that $A \cap \left( D \cup \bigcup_{e \in G} e \right) \times \left( F \cup \bigcup_{f \in H} f\right)$ is closed.
      \begin{proof}
        Indeed, since 
        \begin{equation*}
          A \cap K \subseteq A \cap \left( D \cup \bigcup_{e \in G} e \right) \times \left( F \cup \bigcup_{f \in H} f\right),
        \end{equation*}
        we get
        \begin{equation*}
          A \cap K = K \cap \left(A \cap \left( D \cup \bigcup_{e \in G} e \right) \times \left( F \cup \bigcup_{f \in H} f\right) \right)
        \end{equation*}
    ...
    Now observe that 
    \begin{align*}
      A \cap &\left( D \cup \bigcup_{e \in G} e \right) \times \left( F \cup \bigcup_{f \in H} f\right) \\
