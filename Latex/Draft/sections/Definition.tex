...
\todo[plan]{Talk about subcomplexes and in particular skeletons here.}

A natural notion of maps between CW complexes are \emph{cellular maps}. 
...
\todo[plan]{Continue talking about cellular maps here}