...
\begin{frame}
  \frametitle{Sphere Version 1: Defining the characteristic map}
  Let $n \ge 2$, 
  ...
  D^n \to S^n, x \mapsto 
  \begin{cases}
  (\text{stereographic'} \circ \text{unitBall})^{-1} x & x \in \interior{D^n} \\
  p & x \in S^{n - 1}
  \end{cases}
  \end{equation*}
\end{frame}
...
\begin{frame}
  \frametitle{Sphere Version 1: Difficulties}
  \begin{itemize}
...
\section{Sphere: Version 2}

\begin{frame}
  \frametitle{Sphere Version 2: Choosing a characteristic map}
...
\begin{frame}
  \frametitle{Sphere Version 2: Difficulties}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Version 1 (Two cells overall)
  \begin{itemize}
  ...
  \end{itemize}
  \item Version 2 (Two cells in each dimension)
  \begin{itemize}
  ...
  \end{itemize}
  \uncover<8->{\item I decided to set version 1 as the default}
  \end{itemize}
\end{frame}
